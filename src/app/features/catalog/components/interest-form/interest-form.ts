...
@Component({
  ...
  imports: [CommonModule, NgIf, ReactiveFormsModule,MatDialogModule,MatIconModule,MatButtonModule, MatInputModule, MatSnackBarModule],
...
export class InterestForm {
  ...
  submit() {
    ...
    this.sending = true;
    const formData = {...this.form.value, interestedProduct: this.data?.productId} as CreateInterestFormDTO;
