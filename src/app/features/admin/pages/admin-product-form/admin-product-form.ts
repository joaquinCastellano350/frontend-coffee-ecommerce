...
export class AdminProductForm implements OnInit {
  ...
  async onSubmit() {
    ...
    const request = this.isEdit()
      ...
      : this.service.createProduct(productData as CreateProductDTO, this.selectedFile || undefined);
    ...
    request.subscribe({
      ...
      error: () => {
        this.snack.open('Error al guardar el producto', 'Cerrar', { duration: 3000 });
      },
    });
  }
